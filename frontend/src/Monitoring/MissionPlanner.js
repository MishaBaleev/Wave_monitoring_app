    ...
    return <div className="params_item">
        ...
        <div className="main mission_planner">
            <div className="choose_mission">
                <button onClick={props.toggleUpMis}>Готовые миссии</button>
                <button onClick={props.startMission}>Запустисть миссию</button>
                <button onClick={() => {props.map_manager.clearMission()}}>Очистить карту</button>
            </div>
